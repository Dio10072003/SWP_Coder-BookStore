...
import BestSellerHeader from '../../components/best-seller/BestSellerHeader';
import BookGrid from '../../components/best-seller/BookGrid';
import FilterOptions from '../../components/best-seller/FilterOptions';
import Pagination from '../../components/best-seller/Pagination';
...
{ id: 6, title: 'You Don\'t Know JS Yet (Series)', author: 'Kyle Simpson', price: '180.000', imageUrl: 'https://via.placeholder.com/150/FF8C00/FFFFFF?text=YDKJS', rating: 5, description: 'Một series sách đi sâu vào các khía cạnh nâng cao của JavaScript.' },
    ...
    return (
        <div className="best-seller-page-container min-h-screen bg-gray-50">
            <BestSellerHeader />
            <main className="best-seller-main-content">
                <FilterOptions />
