        ...
        <header className="relative flex flex-col items-center justify-center py-12 md:py-16 bg-gradient-to-br from-blue-200 via-pink-100 to-yellow-100 overflow-hidden rounded-b-3xl shadow-xl mb-10 animate-gradient-move">
            <span className="inline-flex items-center justify-center w-20 h-20 md:w-28 md:h-28 rounded-full bg-white/70 shadow-2xl mb-4 animate-float">
                <svg width="56" height="56" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="text-blue-600 w-14 h-14 md:w-20 md:h-20">
                    <rect x="3" y="7" width="18" height="10" rx="2" fill="#fff" stroke="#3b82f6" strokeWidth="2" />
                    <rect x="7" y="10" width="10" height="1.5" rx="0.75" fill="#fbbf24" />
                    <circle cx="7.5" cy="17" r="1.5" fill="#3b82f6" />
                    <circle cx="16.5" cy="17" r="1.5" fill="#f472b6" />
                </svg>
            </span>
            <h1 className="text-2xl md:text-4xl font-extrabold text-blue-800 drop-shadow-lg text-center mb-2">Phương Thức Thanh Toán</h1>
            <p className="text-base md:text-xl text-gray-700 text-center max-w-2xl font-medium mb-2">Linh hoạt, an toàn, tiện lợi – chọn cách bạn muốn để sở hữu sách yêu thích tại <span className="text-pink-600 font-semibold">Coder-BookStore</span>.</p>
