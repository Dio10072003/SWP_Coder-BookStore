  ...
  return (
    <header className="sticky top-0 z-50 bg-gradient-to-r from-pink-500 via-red-500 to-yellow-400 shadow-lg dark:from-pink-900 dark:via-red-900 dark:to-yellow-700 text-white">
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        <Link
          href="/"
          className="flex items-center gap-2 text-3xl font-extrabold tracking-wide hover:scale-105 transition-transform"
        >
        ...
        <nav className="hidden md:flex gap-8 font-semibold text-lg uppercase tracking-wide">
          ...
          <Link href="/Books" className="hover:text-yellow-200 transition">
            Books
          </Link>
          <Link href="/AboutPage" className="hover:text-yellow-200 transition">
            About
          </Link>
