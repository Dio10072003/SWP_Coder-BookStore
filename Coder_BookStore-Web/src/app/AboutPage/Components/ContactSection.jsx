  ...
  return (
    <section className="py-12 px-4 bg-gray-50 dark:bg-gray-800">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-base md:text-lg text-gray-700 dark:text-gray-200 mb-4 animate-fade-in-slow">{content[lang].desc}</p>
        <div className="flex flex-col sm:flex-row justify-center gap-4 mt-4">
          <a href={`mailto:${content[lang].email}`} className="inline-flex items-center gap-2 px-5 py-2 bg-gradient-to-r from-pink-400 to-yellow-300 text-blue-900 font-bold rounded-full shadow hover:scale-105 hover:shadow-lg transition-all">
            <FaEnvelope /> {content[lang].email}
          </a>
          <a href={`tel:${content[lang].phone.replace(/[^\d+]/g,"")}`} className="inline-flex items-center gap-2 px-5 py-2 bg-gradient-to-r from-blue-400 to-purple-300 text-white font-bold rounded-full shadow hover:scale-105 hover:shadow-lg transition-all">
