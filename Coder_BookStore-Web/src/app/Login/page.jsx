  ...
  return (
    <div className="min-h-[70vh] flex items-center justify-center universe-bg py-10 px-2">
      <form
        ...
        className="relative max-w-sm w-full mx-auto rounded-3xl shadow-2xl p-8 bg-white/10 backdrop-blur-md border-2 border-cyan-400/30 universe-text animate-fade-in overflow-hidden"
      >
        ...
        <div className="relative z-10 flex flex-col items-center gap-2">
          ...
          <h2 className="text-2xl font-extrabold neon mb-4 drop-shadow">
            Đăng nhập
          </h2>
          <div className="w-full flex flex-col gap-3">
            ...
            {error && (
              <div className="text-pink-400 text-sm text-center animate-fade-in">
                {error}
              </div>
            )}
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-cyan-600 to-blue-600 text-white font-bold py-2 rounded-full shadow-lg hover:scale-105 hover:bg-cyan-700 transition-all text-lg mt-2"
            >
