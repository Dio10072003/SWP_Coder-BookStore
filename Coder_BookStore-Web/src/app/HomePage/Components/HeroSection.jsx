  ...
  return (
    <section className="relative overflow-hidden py-20 px-6 text-center bg-gradient-to-br from-purple-700 via-indigo-800 to-fuchsia-700 rounded-3xl shadow-2xl border-4 border-yellow-100">
      ...
      <div className="relative z-20">
        <h1 className="text-5xl md:text-7xl font-extrabold tracking-wider mb-4 animate-bounce-slow">
        ...
        <p className="mt-4 text-lg md:text-2xl text-white/90 animate-fadeIn font-semibold drop-shadow">
        ...
        <Link
          href="/Books"
          className="mt-10 inline-flex items-center gap-2 px-10 py-4 bg-gradient-to-r from-yellow-400 via-pink-400 to-fuchsia-400 text-white text-xl font-extrabold rounded-full shadow-xl hover:scale-110 hover:shadow-2xl transition-all duration-300 border-2 border-white animate-pulse"
        >
