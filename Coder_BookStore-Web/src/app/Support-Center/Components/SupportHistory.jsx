  ...
  return (
    <div className="max-w-2xl mx-auto mt-8">
      ...
      <ul className="space-y-4">
        {tickets.map(ticket => (
          <li key={ticket.id} className="bg-white rounded-lg shadow p-4 border-l-4 border-blue-500 hover:bg-blue-50 transition">
            <Link href={`/Support-Center/ticket/${ticket.id}`} className="block">
              ...
              <div className="text-gray-700 mb-1 line-clamp-2">{ticket.message}</div>
