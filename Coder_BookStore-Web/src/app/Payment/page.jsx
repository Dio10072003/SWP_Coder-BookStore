...
const paymentOptions = [
  {
    ...
    description:
      "Thanh toán trực tiếp cho nhân viên giao hàng ngay khi bạn nhận được sách. Đây là lựa chọn tiện lợi và an toàn.",
    icon: "💵",
  ...
  },
  {
    ...
    description:
      "Thực hiện chuyển khoản trực tiếp vào tài khoản ngân hàng của Coder-BookStore. Thông tin tài khoản sẽ được cung cấp khi bạn chọn phương thức này.",
    icon: "🏦",
    notes:
      "Vui lòng ghi rõ mã đơn hàng trong nội dung chuyển khoản để chúng tôi xác nhận nhanh chóng.",
  },
  {
    title: "Thẻ tín dụng/ghi nợ (Visa, Mastercard, JCB)",
    description:
      "Thanh toán an toàn và nhanh chóng qua cổng thanh toán trực tuyến. Chúng tôi chấp nhận các loại thẻ phổ biến.",
    icon: "💳",
    notes:
      "Đảm bảo thông tin thẻ của bạn chính xác để tránh gián đoạn giao dịch.",
  },
  {
    title: "Ví điện tử (Momo, ZaloPay, VNPay)",
    description:
      "Sử dụng các ví điện tử phổ biến để thanh toán chỉ với vài thao tác trên điện thoại. Tiện lợi và tức thì.",
    icon: "📱",
