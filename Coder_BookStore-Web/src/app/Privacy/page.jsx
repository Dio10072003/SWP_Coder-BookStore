        ...
        <PolicySection
          ...
          icon={
            <svg
              ...
              viewBox="0 0 24 24"
              stroke="currentColor"
              className="text-pink-500 w-8 h-8 animate-float"
            >
              <path
                strokeLinecap="round"
        ...
        >
          <p>
            <span className="font-semibold text-pink-600">
              Chúng tôi chỉ thu thập những gì thực sự cần thiết
            </span>{" "}
            để phục vụ bạn tốt nhất. Dữ liệu của bạn không phải là con số, mà là
            sự tin tưởng!
          </p>
          <ul className="list-disc pl-5 mt-2 space-y-1">
            <li>
              <strong>Thông tin cá nhân:</strong> Họ tên, email, địa chỉ giao
              hàng, số điện thoại, ngày sinh – chỉ khi bạn đăng ký hoặc đặt
              hàng.
            </li>
            <li>
              <strong>Thông tin thanh toán:</strong> Luôn được mã hóa và xử lý
              qua đối tác uy tín. Chúng tôi không bao giờ lưu trữ số thẻ của
              bạn.
            </li>
            <li>
              <strong>Dữ liệu sử dụng:</strong> IP, trình duyệt, trang bạn ghé
              thăm – giúp chúng tôi làm bạn hài lòng hơn mỗi ngày.
            </li>
          </ul>
        </PolicySection>
        ...
        <PolicySection
          ...
          icon={
            <svg
              ...
              viewBox="0 0 24 24"
              stroke="currentColor"
              className="text-purple-500 w-8 h-8 animate-float"
            >
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
        ...
        >
          <p>
            <span className="font-semibold text-purple-600">
              Mỗi dòng dữ liệu là một lời cam kết phục vụ bạn tốt hơn.
            </span>{" "}
          ...
          <ul className="list-disc pl-5 mt-2 space-y-1">
            ...
            <li>
              Cá nhân hóa trải nghiệm: Đề xuất sách, ưu đãi, nội dung phù hợp
              với bạn.
            </li>
            <li>
              Thông báo đơn hàng, vận chuyển, sự kiện mới – chỉ những gì bạn
              quan tâm.
            </li>
        ...
        <PolicySection
          ...
          icon={
            <svg
              ...
              viewBox="0 0 24 24"
              stroke="currentColor"
              className="text-blue-500 w-8 h-8 animate-float"
            >
        ...
        >
          <p>
            <span className="font-semibold text-blue-600">
              Chúng tôi bảo vệ dữ liệu của bạn như chính tài sản của mình.
            </span>{" "}
            Mọi giao dịch đều được mã hóa SSL, hệ thống bảo mật nhiều lớp, không
            lưu trữ thông tin thẻ trên máy chủ. An toàn của bạn là ưu tiên số 1!
          </p>
        </PolicySection>
        ...
        <PolicySection
          ...
          icon={
            <svg
              ...
              viewBox="0 0 24 24"
              stroke="currentColor"
              className="text-yellow-500 w-8 h-8 animate-float"
            >
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
              ...
              <path
                ...
                strokeLinejoin="round"
                strokeWidth={2}
                d="M12 11V7a4 4 0 10-8 0v4m16 0a4 4 0 01-8 0"
              />
            </svg>
          }
        >
          <p>
            <span className="font-semibold text-yellow-600">
              Chúng tôi không bán dữ liệu – chỉ chia sẻ khi thực sự cần thiết.
            </span>{" "}
            Đối tác vận chuyển, thanh toán đều phải tuân thủ bảo mật nghiêm
            ngặt. Chỉ tiết lộ khi pháp luật yêu cầu hoặc để bảo vệ quyền lợi của
            bạn và cộng đồng.
          </p>
        </PolicySection>
