      ...
      <main className="Ship-return-main-content relative z-10 max-w-3xl mx-auto px-4 md:px-0">
        <section className="policy-section-group mb-8">
          <h2 className="text-2xl font-bold text-blue-700 mb-4 flex items-center gap-2">
            ...
            >
              <path
                ...
                strokeWidth={2}
                d="M3 17v-6a2 2 0 012-2h13a2 2 0 012 2v6M5 17h14M7 17v2a2 2 0 002 2h2a2 2 0 002-2v-2"
              />
            </svg>
          ...
          >
            <ul>
              <li>
                <strong>Nội thành Quy Nhơn:</strong> Giao siêu tốc trong 1-2
                ngày làm việc. Đặt hôm nay, nhận sách liền tay!
              </li>
              <li>
                <strong>Các tỉnh thành khác:</strong> Dự kiến 3-5 ngày làm việc,
                tuỳ vị trí và đối tác vận chuyển.
              </li>
              <li>
                <span className="text-blue-600 font-semibold">Lưu ý:</span> Đơn
                cuối tuần/ngày lễ sẽ xử lý vào ngày làm việc tiếp theo.
              </li>
            </ul>
          </ReturnSection>
          <ReturnSection
          ...
          >
            <ul>
              <li>
                <span className="font-semibold text-pink-600">Miễn phí</span>{" "}
                cho đơn từ 300.000 VND.
              </li>
              <li>
                Đơn dưới 300.000 VND: Phí tính theo trọng lượng và địa chỉ, hiển
                thị rõ khi thanh toán.
              </li>
            </ul>
          </ReturnSection>
          <ReturnSection
          ...
          >
            <p>
              Sau khi gửi hàng, bạn sẽ nhận email xác nhận kèm mã vận đơn.{" "}
              <span className="font-semibold text-yellow-600">
                Theo dõi trạng thái
              </span>{" "}
              trực tuyến mọi lúc trên website đối tác vận chuyển.
            </p>
          </ReturnSection>
        </section>
        ...
        <section className="policy-section-group mb-8">
          <h2 className="text-2xl font-bold text-pink-700 mb-4 flex items-center gap-2">
            ...
            >
              <path
                ...
                strokeLinejoin="round"
                strokeWidth={2}
                d="M20 12v1a8 8 0 11-16 0v-1"
              />
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
                strokeWidth={2}
                d="M12 4v4m0 0a4 4 0 014 4v1a4 4 0 01-8 0v-1a4 4 0 014-4z"
              />
            </svg>
          ...
          >
            <p>
              Bạn có thể yêu cầu đổi trả trong{" "}
              <span className="font-semibold text-blue-600">7 ngày</span> kể từ
              khi nhận hàng. Đổi trả dễ dàng, không lo rủi ro!
            </p>
          </ShipSection>
          <ShipSection
          ...
          >
            <ul>
              <li>
                Sách còn nguyên vẹn, chưa sử dụng, không rách, ướt, bẩn, không
                dấu hiệu đã đọc.
              </li>
              <li>Cần có hóa đơn hoặc bằng chứng mua hàng hợp lệ.</li>
              <li>
                Chỉ nhận đổi trả nếu sách lỗi do xuất bản hoặc hư hỏng nặng khi
                vận chuyển.
              </li>
            </ul>
          </ShipSection>
          ...
          >
            <ol className="list-decimal pl-5 space-y-1">
              <li>
                Liên hệ bộ phận hỗ trợ qua email/điện thoại để thông báo yêu cầu
                đổi trả.
              </li>
              <li>
                Cung cấp thông tin đơn hàng và mô tả chi tiết lỗi/hư hỏng.
              </li>
